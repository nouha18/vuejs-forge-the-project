    ...
    <fieldwrapper>
        ...
        <div class="k-form-field-wrap">
            <kinput :style="{ width: '270px' }" 
                ...
                @blur="handleBlur"
                @focus="handleFocus"
                style="height:35px; width:310px;padding-left:0px;margin-left:10px background-color:#ccc; border:1px solid #c9c9c9; border-radius:15px;"
                />
